...
1. Запуск Frontend. Находясь в папке infra, выполните в терминале команду 
    ...
    По адресу <http://127.0.0.1> будет доступен фронтенд веб-приложения, 
    а по адресу <http://127.0.0.1/api/docs/> — подробная спецификация API.
...
13. Админ зона доступна по адресу:

    <http://127.0.0.1:8000/admin/>

14. Интерфейс REST API Django доступен по адресу:
    <http://127.0.0.1:8000/api/>

#### Проект построен на базе данных postgres. Для запуска локально с базой данных SQLite необходимо изменить настройки settings.py - DATABASES.
...
### В папке postman_collection находится JSON коллекция для тестирования REST API в POSTMAN.
